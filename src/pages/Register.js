    ...
    const[state,setState] =useState({
         ...
         var handleSubmit = () => {
            ...
            .then(res=> {
              console.log(res)
                if(res.status==200){
                       console.log()
                       localStorage.setItem('token', "FirstLogin");
                    navigate("/home")
                 }else{
      ...
      return (
        ...
        <div className="container">
            ...
            <div className="signup-box text-light">
              ...
              <div className="row">
                <div className="col-md-6">
                  <div className="form-group">
                    ...
                    {state.formErrors.name && (
                      <span className="err text-danger">{state.formErrors.name}</span>
                    )}
                  </div>
                  <div className="form-group">
                    <label>
                    ...
                    {state.formErrors.email && (
                      <span className="err text-danger">{state.formErrors.email}</span>
                    )}
                  </div>
                  <div className="form-group">
                    <label>
                    ...
                    {state.formErrors.password && (
                      <span className="err text-danger">{state.formErrors.password}</span>
                    )}
                  </div>
                  <div className="form-group">
                    <label>
                    ...
                    {state.formErrors.confirmPassword && (
                      <span className="err text-danger">{state.formErrors.confirmPassword}</span>
                    )}
                  </div>
                ...
                <div className="col-md-6">
                  <div className="form-group">
                    ...
                    {state.formErrors.industry && (
                      <span className="err text-danger">{state.formErrors.industry}</span>
                    )}
                  </div>
                  <div className="form-group">
                    ...
                    {state.formErrors.contact_person_name && (
                      <span className="err text-danger">{state.formErrors.contact_person_name}</span>
                    )}
                  </div>
                  <div className="form-group">
                    <label>
                    ...
                    {state.formErrors.role_id && (
                      <span className="err text-danger">{state.formErrors.role_id}</span>
                    )}
                  </div>
                ...
                {state.formErrors.mobile && (
                  <span className="err text-danger">{state.formErrors.mobile}</span>
                )}
              </div>
                </div>
              </div>
                          <div class="form-check form-group container">
